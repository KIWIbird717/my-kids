  ...
  return (
    ...
    >
      <SwiperSlide className="relative flex h-[405px] w-full !shrink-0 items-center justify-center px-[42px]">
        <div className="mt-[24px] flex h-[45px] w-full items-center gap-6 font-bold text-white">
      ...
      <SwiperSlide className="relative flex !shrink-0 items-center justify-center">
        <div className="mt-[24px] flex h-[45px] w-full items-center gap-6 pl-[43px] font-bold text-white">
      ...
      <SwiperSlide className="relative flex w-full !shrink-0 items-center justify-center px-[42px]">
        <div className="w-[291px]">
          <div className="mt-[24px] flex h-[45px] w-full items-center gap-6 font-bold text-white">
            ...
            <span className="w-[61px] text-end text-[16px] leading-[18.75px] opacity-70">
              Шаг 4
            </span>
          </div>
          <div className="mt-[40px] flex flex-col gap-6">
      ...
      <SwiperSlide className="relative flex !shrink-0 items-center justify-center px-[24px]">
        <div className="mt-[24px] flex h-[45px] w-full items-center gap-6 px-[9px] font-bold text-white">
          <span className="w-[206px] text-[16px] leading-[18.75px]">
            Выберите пол вашего будущего малыша
          </span>
          <span className="w-[61px] text-end text-[16px] leading-[18.75px] opacity-70">Шаг 6</span>
        </div>
        <div className="mt-[40px] flex flex-row gap-[23px] text-white">
          <div
            className={cn(
